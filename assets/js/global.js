...
function updateTextAutocompleteSuggestions( autocompleteField, data ) {
	if(jQuery(autocompleteField).val().length) {
		...
		thisData[ hibachiConfig.action ] = 'ajax.updatelistingdisplay';
...
function listingDisplayUpdate( tableID, data, afterRowID ) {
	...
	if( !listingUpdateHold( tableID, data, afterRowID ) ) {
		...
		data[ hibachiConfig.action ] = 'ajax.updateListingDisplay';
...
function tableApplySort(event, ui) {
	...
	data[ hibachiConfig.action ] = 'ajax.updateSortOrder';
...
function updateGlobalSearchResults() {
	...
	if(!globalSearchHold()) {
		...
		data[ hibachiConfig.action ] = 'ajax.updateGlobalSearchResults';
		
		var buckets = {
			product: {primaryIDProperty:'productID', listAction:'entity.listproduct', detailAction:'entity.detailproduct'},
			productType: {primaryIDProperty:'productTypeID', listAction:'entity.listproducttype', detailAction:'entity.detailproducttype'},
			brand: {primaryIDProperty:'brandID', listAction:'entity.listbrand', detailAction:'entity.detailbrand'},
			promotion: {primaryIDProperty:'promotionID', listAction:'entity.listpromotion', detailAction:'entity.detailpromotion'},
			order: {primaryIDProperty:'orderID', listAction:'entity.listorder', detailAction:'entity.detailorder'},
			account: {primaryIDProperty:'accountID', listAction:'entity.listaccount', detailAction:'entity.detailaccount'},
			vendorOrder: {primaryIDProperty:'vendorOrderID', listAction:'entity.listvendororder', detailAction:'entity.detailvendororder'},
			vendor: {primaryIDProperty:'vendorID', listAction:'entity.listvendor', detailAction:'entity.detailvendor'}
		};
