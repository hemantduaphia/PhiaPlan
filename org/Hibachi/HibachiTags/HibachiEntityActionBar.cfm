<cfif thisTag.executionMode is "start">
	...
	<cfparam name="attributes.showKeywordSearch" type="boolean" default="true" />
					...
					<div class="span8">
						<div class="btn-toolbar">
							...
							<cfif attributes.type eq "listing" >
								...
								<!--- Listing: Search --->
								<cfif attributes.showKeywordSearch>
