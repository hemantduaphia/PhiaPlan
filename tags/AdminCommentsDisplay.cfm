	...
	<div class="tab-pane" id="tabComments">
		<cfoutput>
				...
				<cfloop array="#attributes.object.getComments()#" index="commentRelationship">
					<tr>
						...
						<cfelse>
							...
							<cfif attributes.adminComments><td class="admin1"><cf_HibachiActionCaller action="admin:entity.deletecomment" queryString="commentID=#commentRelationship['comment'].getCommentID()#&#attributes.object.getPrimaryIDPropertyName()#=#attributes.object.getPrimaryIDValue()#&sRenderItem=detail#attributes.object.getClassName()#" class="btn btn-mini" icon="trash" iconOnly="true" /></td></cfif>
						</cfif>
					</tr>
				</cfloop>
			...
			<cfif attributes.adminComments>
				<cf_HibachiActionCaller action="admin:entity.createcomment" querystring="#attributes.object.getPrimaryIDPropertyName()#=#attributes.object.getPrimaryIDValue()#&redirectAction=#request.context.PPAction#" modal="true" class="btn" icon="plus" />
			</cfif>
		</cfoutput>
	</div>
</cfif>